...
class ListSubscribers extends Base
{
     ...
     * @throws Exception
     */
    public function updateByEmail($listUid, $EMAIL, array $data)
    {
        $response = $this->emailSearch($listUid, $EMAIL);
     ...
     * @throws Exception
     */
    public function unsubscribeByEmail($listUid, $EMAIL)
    {
        $response = $this->emailSearch($listUid, $EMAIL);
     ...
     * @throws Exception
     */
    public function unsubscribeByEmailFromAllLists($EMAIL)
    {
        $client = new Client([
            'method'        => Client::METHOD_PUT,
     ...
     * @throws Exception
     */
    public function deleteByEmail($listUid, $EMAIL)
    {
        $response = $this->emailSearch($listUid, $EMAIL);
        $bodyData = $response->body->itemAt('data');
     ...
     * @throws Exception
     */
    public function emailSearchAllLists($EMAIL)
    {
        $client = new Client([
            'method'        => Client::METHOD_GET,
