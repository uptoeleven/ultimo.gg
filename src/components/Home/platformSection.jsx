        ...
        <div className='platform_wrapper'>
          <div className='platform_content'>
            ...
            <p className='platform_content_text-block'>
              Ultimo Warrior is a game-changing esports platform. It allows
              gamers of all skill levels to compete on an even playing field for
              their chance to win huge prizes from cash to top spec hardware.
              Players can hone their skills and compete for recognition in the
              ‘Global Amateur Gaming League’ or compete in fierce one-off flash
